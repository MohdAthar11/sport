...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">CricOne</a>
    </div>
  ...
  <div class="row content">
    ...
    <div class="col-sm-2 sidenav">
      <div class="well">
        ...
        <img src="images/virat-kohli.png" alt="Kohli" height="75" width="75">
      ...
      <div class="well">
        <p>Trending Teams</p>
        <img src="images/Indialogo.png" alt="India" height="75" width="75">
