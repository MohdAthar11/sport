  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Players <span class="caret"></span></a>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <table border=\"1"\>
      	<tr>
			<th width="150px">ID</th><th width="150px">Name</th><th width="150px">Country</th><th width="150px">Delete</th>
			
			</tr>
      <%for(Player p : (ArrayList<Player>)request.getAttribute("players")){ %>
       	<tr>
			<td><%= p.getId() %></td>
			<td><%= p.getFirstName()%> <%= p.getLastName() %></td>
			<%-- <td><%= p.getDob() %></td> --%>
			<td><%= p.getCountry().getShortName() %></td>
			<td><a href=<%= "\"deletePlayer?id=" + p.getId() + "\"" %>>Delete</a></td>
		</tr>
		<%} %>
	</table>
    </div>
